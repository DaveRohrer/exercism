...
describe('School', () => {
  ...
  test('adding students to different grades adds them to the roster in the correct grade order', () => {
    school.add('Logan', 7);
    school.add('Chelsea', 3);
    school.add('KindyKid', 'K');
    school.add('PreKKid', 'PreK');

    const expectedDb = { PreK: ['PreKKid'], K: ['KindyKid'], 3: ['Chelsea'], 7: ['Logan'] };
    expect(school.roster()).toEqual(expectedDb);
  });
