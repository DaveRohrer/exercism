...
describe('LinkedList', () => {
  ...
  test('count a list with items added with shift and push', () => {
    const list = new LinkedList();
    list.unshift(372);
    list.push(1233);
    list.push(122);
  ...
  test("shifting to empty doesn't break the list with more pushes and shifts", () => {
    const list = new LinkedList();
    list.push(41);
    list.push(59);
    list.push(49);
  ...
  test("popping on empty doesn't break the list", () => {
    const list = new LinkedList();
    list.push(41);
    list.pop();
    list.pop();
  ...
  test("shifting on empty doesn't break the list", () => {
    const list = new LinkedList();
    list.push(41);
    list.shift();
    list.shift();
  ...
  test('deletes the second of three elements', () => {
    const list = new LinkedList();
    list.push(97);
    list.push(101);
    list.push(102);
    ...
    expect(list.count()).toBe(2);
    expect(list.pop()).toBe(102);
    expect(list.pop()).toBe(97);
  });

  test('deletes the last of three elements', () => {
    const list = new LinkedList();
    list.push(97);
    list.push(101);
    list.push(102);
